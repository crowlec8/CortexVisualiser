...
* 1D: This views the memory in a one dimensional array
* 2D: This views the memory in a two dimensional array
* Ascii: This views the memory as ascii strings and prints acordingly
* Stack: This views the stack memory
